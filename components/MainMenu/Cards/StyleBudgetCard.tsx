...
export default function StyleBudgetCard() {
  ...
  const goToBudget = () => {
    router.push("/(tabs)/budgeting" as any);
  };
    ...
    >
      <View style={[s.content, isMobile && s.contentMobile]}>
        <View style={s.textContent}>
          <Text style={[s.eyebrow, { fontSize: eyebrowSize }]}>SMART SHOPPING</Text>

          <Text style={[s.title, { fontSize: titleSize, lineHeight: titleSize + 4 }]}>Style Budget</Text>

          <Text style={[s.subtitle, { fontSize: subtitleSize, lineHeight: subtitleSize + 6 }]}> 
            Plan your fashion spending and build your wardrobe with purpose.
          </Text>
        </View>

        <View style={s.button}>
          <Text style={[s.buttonText, { fontSize: buttonTextSize }]}>View budget</Text>
...
const s = StyleSheet.create({
  ...
  button: {
    ...
    borderRadius: 12,
    backgroundColor: "rgba(125,102,64,0.13)",
    flexDirection: "row",
    alignItems: "center",
