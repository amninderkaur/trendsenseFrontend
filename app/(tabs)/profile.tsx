...
export default function Profile() {
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: themeColors.bg }]} contentContainerStyle={{ paddingBottom: 30 }}>
      <View style={styles.header}>
        <TouchableOpacity style={[styles.backButton, { backgroundColor: themeColors.button }]} onPress={() => router.back()}>
      ...
      <View style={[styles.card, { backgroundColor: themeColors.card }]}>
        ...
        <Text style={[styles.name, { color: themeColors.text }]}>TrendSense User</Text>
      ...
      <Pressable style={[styles.button, { backgroundColor: themeColors.button }]} onPress={() => router.push("/reviews" as any)}>
        <Text style={styles.buttonText}>Leave / View Reviews</Text>
      </Pressable>
      <Pressable style={[styles.button, { backgroundColor: themeColors.button }]} onPress={() => router.push("/admin/dashboard" as any)}>
